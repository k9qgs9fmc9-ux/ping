...
import { Layout, Menu, Button, Input, Card, Steps, Result, Spin, Typography, Space } from 'antd';
        ...
        <Card className="glass-panel" bordered={false}>
          ...
          {step === 0 && (
            <div style={{ textAlign: 'center' }}>
              <Title level={4} style={{ marginBottom: 16 }}>你想做一个什么样的演示文稿？</Title>
              <TextArea 
                rows={6} 
          ...
          {step === 1 && (
            <Result
              ...
              extra={[
                <Button type="primary" key="download" icon={<DownloadOutlined />} size="large">
                  下载 PPT 文件
                </Button>,
                <Button key="regenerate" onClick={() => setStep(0)}>
                  重新生成
                </Button>,
              ]}
            >
